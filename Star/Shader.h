...
public:
	...
	void setFloat(const GLchar* name, float offset)
	{
		GLint vertexColorLocation = glGetUniformLocation(Program, name);
    ...
    {
		Program = 0;
		ShaderLoad(vertexPath, fragmentPath);
    }
	void ShaderLoad(const GLchar* vertexPath, const GLchar* fragmentPath)
	{
		Program = 0;
	...
	void setVec1(const GLchar* name, GLfloat x) const
	{
