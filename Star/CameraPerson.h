...
const GLfloat YAW_p        = -90.0f;
const GLfloat PITCH_p      =  0.0f;
const GLfloat SPEED_p      =  50.0f;
const GLfloat SENSITIVTY_p =  0.25f;
const GLfloat ZOOM_p       =  45.0f;
